...
public class UserController {
	...
	public String doUpdate(HttpServletRequest req, UserVO param)throws SQLException {
		...
		String message = "";
		if(1 == flag) {
			message = param.getName()+"님 정보가 수정 되었습니다.";
		}else {
			message = param.getName()+"님 정보가 수정 실패 했습니다.";
		}
	...
	public String doDelete(HttpServletRequest req, 
		...
		if(1==flag) {
			...
			message = inVO.getUserId()+"님이 삭제 실패 했습니다..";
		}
	...
	public String doSave(HttpServletRequest req, UserVO param) throws SQLException {
	    ...
	    param.setRegDt(currentDate);  // UserVO에 날짜 설정
		...
		if(1 == flag) {
			message = param.getName()+"님 등록 성공 했습니다.";
		}else {
